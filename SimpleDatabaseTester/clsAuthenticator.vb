...
Public Class clsAuthenticator
    ...
    Declare Auto Function DuplicateToken Lib "advapi32.dll" (ByVal ExistingTokenHandle As IntPtr, ByVal SECURITY_IMPERSONATION_LEVEL As Int16, ByRef DuplicateTokenHandle As IntPtr) As Boolean
    ...
    ' 
    Public Sub Start(Optional ByVal sDomain As String = "am.bm.net", Optional ByVal sUsername As String = "gelab", Optional ByVal sPassword As String = "std_lab09")
        ' initialize tokens
        ...
        ' sDomain = System.Environment.MachineName
        Try
            'sDomain = System.Environment.SystemDirector
